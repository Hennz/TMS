...
namespace TMS {
    ...
    public partial class TMS_DatabaseDataSet4 : global::System.Data.DataSet {
        ...
        public partial class MembersDataTable : global::System.Data.TypedTableBase<MembersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public MembersRow AddMembersRow(string memberNo, string fName, string mName, string lName, string address, string phoneNo, string mobileNo) {
...
namespace TMS.TMS_DatabaseDataSet4TableAdapters {
    ...
    public partial class MembersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Members] SET [memberNo] = @memberNo, [fName] = @fName, [mName] = @mName, [lName] = @lName, [address] = @address, [phoneNo] = @phoneNo, [mobileNo] = @mobileNo WHERE (([memberNo] = @Original_memberNo));
SELECT memberNo, fName, mName, lName, address, phoneNo, mobileNo FROM Members WHERE (memberNo = @memberNo)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT memberNo, fName, mName, lName, address, phoneNo, mobileNo FROM dbo.Members" +
                "";
        ...
        public virtual int Update(string memberNo, string fName, string mName, string lName, string address, string phoneNo, string mobileNo, string Original_memberNo) {
            if ((memberNo == null)) {
            ...
            if ((Original_memberNo == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_memberNo));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fName, string mName, string lName, string address, string phoneNo, string mobileNo, string Original_memberNo) {
            return this.Update(Original_memberNo, fName, mName, lName, address, phoneNo, mobileNo, Original_memberNo);
        }
    }
