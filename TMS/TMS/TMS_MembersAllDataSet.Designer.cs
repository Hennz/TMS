    ...
    public partial class TMS_DatabaseDataSet4 : global::System.Data.DataSet {
        ...
        public partial class MembersRow : global::System.Data.DataRow {
            ...
            public string tagId {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'tagId\' in table \'Members\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IstagIdNull() {
                return this.IsNull(this.tableMembers.tagIdColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SettagIdNull() {
                this[this.tableMembers.tagIdColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace TMS.TMS_DatabaseDataSet4TableAdapters {
    ...
    public partial class MembersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Members] WHERE (([memberNo] = @Original_memberNo) AND ((@IsNul" +
                "l_tagId = 1 AND [tagId] IS NULL) OR ([tagId] = @Original_tagId)))";
...
SELECT memberNo, fName, mName, lName, address, phoneNo, mobileNo, tagId FROM Members WHERE (memberNo = @memberNo)";
        ...
        public virtual int Delete(string Original_memberNo, string Original_tagId) {
            ...
            if ((Original_tagId == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[2].Value = ((string)(Original_tagId));
            }
